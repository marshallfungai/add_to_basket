...
?><ul class="repeaters"><?php
	...
	for ( $i = 0; $i <= $count; $i++ ) {
		...
		<div class="handle">
			<span class="title-repeater"><?php echo esc_html( $setatts['label-header'], 'add2basket' ); ?></span>
			<button aria-expanded="true" class="btn-edit" type="button">
				<span class="screen-reader-text"><?php echo esc_html( $setatts['label-edit'], 'add2basket' ); ?></span>
			...
			<div>
				<a class="link-remove" href="#">
						<span><?php
							...
							echo esc_html( apply_filters( $this->plugin_name . '-repeater-remove-link-label', $setatts['label-remove'] ), 'add2basket' );
	...
	?><div class="repeater-more">
		...
		<a class="button" href="#" id="add-repeater"><?php
			...
			echo esc_html( apply_filters( $this->plugin_name . '-repeater-more-link-label', $setatts['label-add'] ), 'add2basket' );
